...
JOBS: List[CutterJob] = [
    ...
    # ),
    CutterJob(
        input_path="/media/ikuta/Expansion/2022-12-04/Morning/2022-12-01_15-20-48.388_wildpose_v1.1",
        range=CutRange(start_seconds=0, end_seconds=38),
        output_root="/mnt/data/WildPose_v1.1/Wildebeest/2022-12-04_001",
    ),
]
