...
JOBS: List[CutterJob] = [
    ...
    # ),
    CutterJob(
        input_path="/media/ikuta/Expansion/2022-12-15/Morning/2022-12-15_11-47-40.017_wildpose_v1.1",
        range=CutRange(start_seconds=0, end_seconds=90),
        output_root="/mnt/vault/WildPose_dataset/Leopard/2022-12-15_001",
    ),
]
