...
JOBS: List[CutterJob] = [
    ...
    # ),
    CutterJob(
        input_path="/media/ikuta/Expansion/2022-12-04/Morning/2022-12-01_18-02-59.876_wildpose_v1.1",
        range=CutRange(start_seconds=11, end_seconds=24),
        output_root="/mnt/data/WildPose_v1.1/Gabar_goshawk/2022-12-04_001",
    ),
]
