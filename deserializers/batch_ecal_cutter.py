...
JOBS: List[CutterJob] = [
    ...
    # ),
    CutterJob(
        input_path="/media/ikuta/Expansion/2022-12-04/Morning/2022-12-01_16-51-56.408_wildpose_v1.1",
        range=CutRange(start_seconds=89, end_seconds=-1),
        output_root="/mnt/data/WildPose_v1.1/Wildebeest/2022-12-04_005",
    ),
]
